...
4. Offer resolution in order:
   a. "I'd love to get the correct items sent out to you right away — would a free replacement work?"
      → If YES → ESCALATE: reship | REASON: Customer accepted reship for wrong/missing item
...
- ENTIRE ORDER WRONG → ESCALATE: reship | REASON: Entire order wrong, full reship needed
